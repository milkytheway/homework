...
void StartKeyTask(void *argument)
{
  ...
  for(;;)
  {
		...
		//check key queue
		if(pdTRUE == xQueueReceive(Key_queue_irq, &(key_event), (TickType_t) 0))
		{
...
KEY_CALLBACK
{
    ...
    */
    ...
    {
        KEY_PRESSE_EVENT_t key_press_event_1 = 
        {
            .edge_t    = FALING,
    ...
    */
         KEY_PRESSE_EVENT_t key_press_event_2 = 
        {
            .edge_t    = RASING,
            .trigger_tick = HAL_GetTick()
        };
